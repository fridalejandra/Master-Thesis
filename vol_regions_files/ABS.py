...
f = '/Users/fridaperez/Developer/repos/volume-thickness/Volume_ENV-CYS_2002-2018_25000smth1.nc'
...
## Create a matrix that is True where longitude is between 70E and 165W and False otherwise.
lon_boundsR = np.logical_and(df.longitude <= -65.0, df.longitude >= -110.0)
...
table_month.to_csv('/Users/fridaperez/Developer/repos/local_repo/vol_regions_files/ABS_02-18_months.csv')
table_yr.to_csv('/Users/fridaperez/Developer/repos/local_repo/vol_regions_files/ABS_02-18_years.csv')
